...
# DEFINE results dict 
iterations = [0, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6200]
...
for i, mat in enumerate(matrix_types):
    ...
    # absolute 
    abs_arr = np.array(results['adamw'][mat]).T
...
plt.tight_layout()
plt.savefig('analyse/plots/effective_rank_absolute_heatmap.png', dpi = 600)
plt.close()